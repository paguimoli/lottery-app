  ...
  JSON.stringify(
    {
      ...
      financialInvariants: baseline.financialInvariants,
      rollbackDrillSummary: baseline.rollbackDrillSummary,
      eventAudit: {
        status: baseline.eventAudit.status,
        pendingOutboxCount: baseline.eventAudit.pendingOutboxCount,
        failedOutboxCount: baseline.eventAudit.failedOutboxCount,
        deadLetterOutboxCount: baseline.eventAudit.deadLetterOutboxCount,
        recentAuthorityEventCount:
          baseline.eventAudit.recentAuthorityEvents.length,
        recentCertificationEventCount:
          baseline.eventAudit.recentCertificationEvents.length,
        warnings: baseline.eventAudit.warnings,
      },
      serviceWorkerObservability: baseline.serviceWorkerObservability,
