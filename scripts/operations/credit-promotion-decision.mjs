...
const response = await fetch(`${appUrl}/api/authority/promotion-decision?domain=credit`, {
...
console.log(JSON.stringify({ status: "PASS", decision: payload.decision }, null, 2));
