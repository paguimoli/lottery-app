...
const response = await fetch(`${appUrl}/api/credit-shadow/mismatches${suffix}`, {
...
console.log(JSON.stringify({ status: "PASS", count: body.mismatches.length, mismatches: body.mismatches }, null, 2));
