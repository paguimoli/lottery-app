...
const TARGET = {
  name: "Ticket purchase evidence reads",
...
function summarize({ elapsedSeconds, latencies, successCount, failureCount, resultCount, memory, queryCount }) {
  return {
    averageLatencyMs:
      latencies.length > 0
  ...
  JSON.stringify(
    {
      ...
      filesTouched: [
        ...
        "scripts/operations/ticket-evidence-optimization-report.mjs",
        "scripts/qa/ticket-evidence-optimization.mjs",
      ],
      revertedAttempts: [],
