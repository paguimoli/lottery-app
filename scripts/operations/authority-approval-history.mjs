...
const response = await fetch(
  `${appUrl}/api/authority/approval-history?authorityCandidate=SETTLEMENT`,
  {
...
console.log(JSON.stringify({ status: "PASS", approvalHistory: payload.approvalHistory }, null, 2));
